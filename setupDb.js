...
const DELETED_QUERY = `deleted INT(1) DEFAULT 0`
const NAME_QUERY = `${CONSTANTS.DATABASE.IMAGE_TABLE.COLUMNS.NAME} VARCHAR(33)`

const POSTS_TABLE_CREATE_QUERY = `CREATE TABLE ${DATABASE}.${CONSTANTS.DATABASE.POSTS_TABLE.NAME} (${ID_QUERY}, ${IMAGE_ID_QUERY}, ${TITLE_QUERY}, ${CONTENT_QUERY}, ${CREATED_AT_QUERY}, ${UPDATED_AT_QUERY}, ${DELETED_QUERY})`
